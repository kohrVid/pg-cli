...
var stepCmd = &cobra.Command{
	Use:   "step",
	Short: "Apply only migrations up to a given step in the database",
	Long:  `Apply only migrations up to a given step in the postgres database generated by pg CLI`,
