...
var upCmd = &cobra.Command{
	Use:   "up",
	Short: "Apply all up migrations in the database",
	Long:  `Apply all up migrations in the postgres database generated by pg CLI`,
	Run: func(cmd *cobra.Command, args []string) {
		...
		err = db.MigrateUp(conf, migrationPath)
		if err != nil {
